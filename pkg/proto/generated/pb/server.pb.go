...
// produces no output.
type HeadIntentState int32

const (
	HeadIntentState_HEAD_INTENT_STATE_UNSPECIFIED     HeadIntentState = 0 // never sent; guards against a defaulted field
	HeadIntentState_HEAD_INTENT_STATE_DISABLED        HeadIntentState = 1 // receiver not running
	HeadIntentState_HEAD_INTENT_STATE_FAULT           HeadIntentState = 2 // socket/config error
	HeadIntentState_HEAD_INTENT_STATE_IDLE            HeadIntentState = 3 // running, no valid packet yet
	HeadIntentState_HEAD_INTENT_STATE_INVALID         HeadIntentState = 4 // only invalid packets seen
	HeadIntentState_HEAD_INTENT_STATE_STALE           HeadIntentState = 5 // had valid, silent > stale_ms
	HeadIntentState_HEAD_INTENT_STATE_INACTIVE        HeadIntentState = 6 // fresh valid, tracking disabled
	HeadIntentState_HEAD_INTENT_STATE_NOT_CENTERED    HeadIntentState = 7 // fresh valid, enabled, not centered
	HeadIntentState_HEAD_INTENT_STATE_ACTIVE_LOG_ONLY HeadIntentState = 8 // fresh valid, enabled, centered (still no output)
)

// Enum value maps for HeadIntentState.
var (
	HeadIntentState_name = map[int32]string{
		0: "HEAD_INTENT_STATE_UNSPECIFIED",
		1: "HEAD_INTENT_STATE_DISABLED",
		2: "HEAD_INTENT_STATE_FAULT",
		3: "HEAD_INTENT_STATE_IDLE",
		4: "HEAD_INTENT_STATE_INVALID",
		5: "HEAD_INTENT_STATE_STALE",
		6: "HEAD_INTENT_STATE_INACTIVE",
		7: "HEAD_INTENT_STATE_NOT_CENTERED",
		8: "HEAD_INTENT_STATE_ACTIVE_LOG_ONLY",
	}
	HeadIntentState_value = map[string]int32{
...
func (x HeadIntentState) Enum() *HeadIntentState {
	p := new(HeadIntentState)
	*p = x
	return p
}

func (x HeadIntentState) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (HeadIntentState) Descriptor() protoreflect.EnumDescriptor {
	return file_server_proto_enumTypes[6].Descriptor()
}

func (HeadIntentState) Type() protoreflect.EnumType {
	return &file_server_proto_enumTypes[6]
}

func (x HeadIntentState) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use HeadIntentState.Descriptor instead.
func (HeadIntentState) EnumDescriptor() ([]byte, []int) {
...
type HeadIntentDiagnostics struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	State              HeadIntentState `protobuf:"varint,1,opt,name=state,proto3,enum=JoystickControl.HeadIntentState" json:"state,omitempty"`
	TotalCount         uint64          `protobuf:"varint,2,opt,name=total_count,json=totalCount,proto3" json:"total_count,omitempty"`
	ValidCount         uint64          `protobuf:"varint,3,opt,name=valid_count,json=validCount,proto3" json:"valid_count,omitempty"`
	InvalidCount       uint64          `protobuf:"varint,4,opt,name=invalid_count,json=invalidCount,proto3" json:"invalid_count,omitempty"`
	HasLastValid       bool            `protobuf:"varint,5,opt,name=has_last_valid,json=hasLastValid,proto3" json:"has_last_valid,omitempty"`
	LastValidSeq       int64           `protobuf:"varint,6,opt,name=last_valid_seq,json=lastValidSeq,proto3" json:"last_valid_seq,omitempty"`
	SeqGaps            uint64          `protobuf:"varint,7,opt,name=seq_gaps,json=seqGaps,proto3" json:"seq_gaps,omitempty"`
	SeqRepeats         uint64          `protobuf:"varint,8,opt,name=seq_repeats,json=seqRepeats,proto3" json:"seq_repeats,omitempty"`
	SeqRegressions     uint64          `protobuf:"varint,9,opt,name=seq_regressions,json=seqRegressions,proto3" json:"seq_regressions,omitempty"`
	ReceiveAgeMs       int64           `protobuf:"varint,10,opt,name=receive_age_ms,json=receiveAgeMs,proto3" json:"receive_age_ms,omitempty"` // server-computed; meaningful only if has_last_valid
	RatePerSec         int32           `protobuf:"varint,11,opt,name=rate_per_sec,json=ratePerSec,proto3" json:"rate_per_sec,omitempty"`
	YawDeg             float64         `protobuf:"fixed64,12,opt,name=yaw_deg,json=yawDeg,proto3" json:"yaw_deg,omitempty"` // from the last valid packet
	PitchDeg           float64         `protobuf:"fixed64,13,opt,name=pitch_deg,json=pitchDeg,proto3" json:"pitch_deg,omitempty"`
	RollDeg            float64         `protobuf:"fixed64,14,opt,name=roll_deg,json=rollDeg,proto3" json:"roll_deg,omitempty"`
	TrackingEnabled    bool            `protobuf:"varint,15,opt,name=tracking_enabled,json=trackingEnabled,proto3" json:"tracking_enabled,omitempty"`
	Centered           bool            `protobuf:"varint,16,opt,name=centered,proto3" json:"centered,omitempty"`
	HasCentered        bool            `protobuf:"varint,17,opt,name=has_centered,json=hasCentered,proto3" json:"has_centered,omitempty"`               // distinguishes "centered absent" from "false"
	SenderTimeoutMs    int32           `protobuf:"varint,18,opt,name=sender_timeout_ms,json=senderTimeoutMs,proto3" json:"sender_timeout_ms,omitempty"` // sender hint only; not the freshness authority
	HasSenderTimeout   bool            `protobuf:"varint,19,opt,name=has_sender_timeout,json=hasSenderTimeout,proto3" json:"has_sender_timeout,omitempty"`
	SenderClockDeltaMs int64           `protobuf:"varint,20,opt,name=sender_clock_delta_ms,json=senderClockDeltaMs,proto3" json:"sender_clock_delta_ms,omitempty"` // diagnostic; meaningful only if has_last_valid
	StaleMs            int64           `protobuf:"varint,21,opt,name=stale_ms,json=staleMs,proto3" json:"stale_ms,omitempty"`                                      // the receive-time freshness boundary
	LastError          string          `protobuf:"bytes,22,opt,name=last_error,json=lastError,proto3" json:"last_error,omitempty"`                                 // concise fault / last socket error, or ""
}

func (x *HeadIntentDiagnostics) Reset() {
	*x = HeadIntentDiagnostics{}
	if protoimpl.UnsafeEnabled {
...
func (x *HeadIntentDiagnostics) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HeadIntentDiagnostics) ProtoMessage() {}

func (x *HeadIntentDiagnostics) ProtoReflect() protoreflect.Message {
	mi := &file_server_proto_msgTypes[59]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HeadIntentDiagnostics.ProtoReflect.Descriptor instead.
func (*HeadIntentDiagnostics) Descriptor() ([]byte, []int) {
	return file_server_proto_rawDescGZIP(), []int{59}
}

func (x *HeadIntentDiagnostics) GetState() HeadIntentState {
	if x != nil {
		return x.State
	}
	return HeadIntentState_HEAD_INTENT_STATE_UNSPECIFIED
}

func (x *HeadIntentDiagnostics) GetTotalCount() uint64 {
	if x != nil {
		return x.TotalCount
	}
	return 0
...
func (x *HeadIntentDiagnostics) GetValidCount() uint64 {
	if x != nil {
		return x.ValidCount
	}
	return 0
...
func (x *HeadIntentDiagnostics) GetInvalidCount() uint64 {
	if x != nil {
...
func (x *HeadIntentDiagnostics) GetHasLastValid() bool {
	if x != nil {
		return x.HasLastValid
	}
	return false
}

func (x *HeadIntentDiagnostics) GetLastValidSeq() int64 {
	if x != nil {
		return x.LastValidSeq
	}
	return 0
}

func (x *HeadIntentDiagnostics) GetSeqGaps() uint64 {
	if x != nil {
		return x.SeqGaps
	}
	return 0
...
func (x *HeadIntentDiagnostics) GetSeqRepeats() uint64 {
	if x != nil {
		return x.SeqRepeats
	}
	return 0
...
func (x *HeadIntentDiagnostics) GetSeqRegressions() uint64 {
	if x != nil {
		return x.SeqRegressions
	}
	return 0
}

func (x *HeadIntentDiagnostics) GetReceiveAgeMs() int64 {
	if x != nil {
		return x.ReceiveAgeMs
	}
	return 0
}

func (x *HeadIntentDiagnostics) GetRatePerSec() int32 {
	if x != nil {
		return x.RatePerSec
	}
	return 0
...
func (x *HeadIntentDiagnostics) GetYawDeg() float64 {
	if x != nil {
		return x.YawDeg
	}
	return 0
...
func (x *HeadIntentDiagnostics) GetPitchDeg() float64 {
	if x != nil {
		return x.PitchDeg
	}
	return 0
...
func (x *HeadIntentDiagnostics) GetRollDeg() float64 {
	if x != nil {
		return x.RollDeg
	}
	return 0
...
func (x *HeadIntentDiagnostics) GetTrackingEnabled() bool {
	if x != nil {
...
func (x *HeadIntentDiagnostics) GetCentered() bool {
	if x != nil {
		return x.Centered
	}
	return false
...
func (x *HeadIntentDiagnostics) GetHasCentered() bool {
	if x != nil {
		return x.HasCentered
	}
	return false
}

func (x *HeadIntentDiagnostics) GetSenderTimeoutMs() int32 {
	if x != nil {
		return x.SenderTimeoutMs
	}
	return 0
}

func (x *HeadIntentDiagnostics) GetHasSenderTimeout() bool {
	if x != nil {
		return x.HasSenderTimeout
	}
	return false
}

func (x *HeadIntentDiagnostics) GetSenderClockDeltaMs() int64 {
	if x != nil {
		return x.SenderClockDeltaMs
	}
	return 0
}

func (x *HeadIntentDiagnostics) GetStaleMs() int64 {
	if x != nil {
		return x.StaleMs
	}
	return 0
...
func (x *HeadIntentDiagnostics) GetLastError() string {
	if x != nil {
		return x.LastError
	}
	return ""
...
var file_server_proto_rawDesc = []byte{
	...
	0x0a, 0x6c, 0x69, 0x6e, 0x6b, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0xb1, 0x06, 0x0a, 0x15,
	0x48, 0x65, 0x61, 0x64, 0x49, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x44, 0x69, 0x61, 0x67, 0x6e, 0x6f,
	0x73, 0x74, 0x69, 0x63, 0x73, 0x12, 0x36, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x20, 0x2e, 0x4a, 0x6f, 0x79, 0x73, 0x74, 0x69, 0x63, 0x6b, 0x43,
	0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x2e, 0x48, 0x65, 0x61, 0x64, 0x49, 0x6e, 0x74, 0x65, 0x6e,
	...
	,
	...
	,
	...
	,
...
var file_server_proto_msgTypes = make([]protoimpl.MessageInfo, 61)
var file_server_proto_goTypes = []interface{}{
	...
	(HeadIntentState)(0),               // 6: JoystickControl.HeadIntentState
	...
	(*HeadIntentDiagnostics)(nil),      // 66: JoystickControl.HeadIntentDiagnostics
	nil,                                // 67: JoystickControl.EvalStates.StatesEntry
...
var file_server_proto_depIdxs = []int32{
	...
	68, // 4: JoystickControl.GetConfigRes.config:type_name -> google.protobuf.Struct
	68, // 5: JoystickControl.SetConfigReq.config:type_name -> google.protobuf.Struct
	...
	67, // 11: JoystickControl.EvalStates.states:type_name -> JoystickControl.EvalStates.StatesEntry
	...
	39, // 14: JoystickControl.Telemetry.link_stats:type_name -> JoystickControl.LinkStatsData
	38, // 15: JoystickControl.Telemetry.attitude:type_name -> JoystickControl.AttitudeData
	41, // 16: JoystickControl.Telemetry.battery:type_name -> JoystickControl.BatteryData
	40, // 17: JoystickControl.Telemetry.gps:type_name -> JoystickControl.GPSData
	34, // 18: JoystickControl.Telemetry.flight_mode:type_name -> JoystickControl.FlightModeData
	37, // 19: JoystickControl.Telemetry.sync:type_name -> JoystickControl.SyncData
	35, // 20: JoystickControl.Telemetry.link_tx:type_name -> JoystickControl.LinkTXData
	36, // 21: JoystickControl.Telemetry.link_rx:type_name -> JoystickControl.LinkRXData
	31, // 22: JoystickControl.Telemetry.barometer:type_name -> JoystickControl.BarometerData
	32, // 23: JoystickControl.Telemetry.variometer:type_name -> JoystickControl.VariometerData
	33, // 24: JoystickControl.Telemetry.barometer_variometer:type_name -> JoystickControl.BarometerVariometerData
	30, // 25: JoystickControl.Telemetry.device_info:type_name -> JoystickControl.CRSFDeviceInfoData
	29, // 26: JoystickControl.Telemetry.device_field_entry:type_name -> JoystickControl.CRSFDeviceFieldEntryData
	45, // 27: JoystickControl.Telemetry.device_field:type_name -> JoystickControl.CRSFDeviceFieldData
	28, // 28: JoystickControl.Telemetry.device_link_status:type_name -> JoystickControl.CRSFDeviceLinkStatusData
	...
	30, // 31: JoystickControl.GetCRSFDevicesRes.devices:type_name -> JoystickControl.CRSFDeviceInfoData
	45, // 32: JoystickControl.GetCRSFDeviceFieldsRes.fields:type_name -> JoystickControl.CRSFDeviceFieldData
	46, // 33: JoystickControl.CRSFDeviceFieldData.uint8:type_name -> JoystickControl.CRSFDeviceFieldUint8
	47, // 34: JoystickControl.CRSFDeviceFieldData.int8:type_name -> JoystickControl.CRSFDeviceFieldInt8
	48, // 35: JoystickControl.CRSFDeviceFieldData.uint16:type_name -> JoystickControl.CRSFDeviceFieldUint16
	49, // 36: JoystickControl.CRSFDeviceFieldData.int16:type_name -> JoystickControl.CRSFDeviceFieldInt16
	50, // 37: JoystickControl.CRSFDeviceFieldData.uint32:type_name -> JoystickControl.CRSFDeviceFieldUint32
	51, // 38: JoystickControl.CRSFDeviceFieldData.int32:type_name -> JoystickControl.CRSFDeviceFieldInt32
	52, // 39: JoystickControl.CRSFDeviceFieldData.uint64:type_name -> JoystickControl.CRSFDeviceFieldUint64
	53, // 40: JoystickControl.CRSFDeviceFieldData.int64:type_name -> JoystickControl.CRSFDeviceFieldInt64
	54, // 41: JoystickControl.CRSFDeviceFieldData.float:type_name -> JoystickControl.CRSFDeviceFieldFloat
	59, // 42: JoystickControl.CRSFDeviceFieldData.text_select:type_name -> JoystickControl.CRSFDeviceFieldTextSelect
	56, // 43: JoystickControl.CRSFDeviceFieldData.string:type_name -> JoystickControl.CRSFDeviceFieldString
	57, // 44: JoystickControl.CRSFDeviceFieldData.folder:type_name -> JoystickControl.CRSFDeviceFieldFolder
	55, // 45: JoystickControl.CRSFDeviceFieldData.info:type_name -> JoystickControl.CRSFDeviceFieldInfo
	58, // 46: JoystickControl.CRSFDeviceFieldData.command:type_name -> JoystickControl.CRSFDeviceFieldCommand
	...
	30, // 62: JoystickControl.GetCRSFDeviceFieldReq.device:type_name -> JoystickControl.CRSFDeviceInfoData
	30, // 63: JoystickControl.GetCRSFDeviceFieldsReq.device:type_name -> JoystickControl.CRSFDeviceInfoData
	45, // 64: JoystickControl.GetCRSFDeviceFieldRes.field:type_name -> JoystickControl.CRSFDeviceFieldData
	30, // 65: JoystickControl.SetCRSFDeviceFieldReq.device:type_name -> JoystickControl.CRSFDeviceInfoData
	45, // 66: JoystickControl.SetCRSFDeviceFieldReq.field:type_name -> JoystickControl.CRSFDeviceFieldData
	45, // 67: JoystickControl.SetCRSFDeviceFieldRes.field:type_name -> JoystickControl.CRSFDeviceFieldData
	28, // 68: JoystickControl.GetCRSFDeviceLinkStatusRes.link_status:type_name -> JoystickControl.CRSFDeviceLinkStatusData
	6,  // 69: JoystickControl.HeadIntentDiagnostics.state:type_name -> JoystickControl.HeadIntentState
	...
	7,  // 92: JoystickControl.JoystickControl.WatchHeadIntentDiagnostics:input_type -> JoystickControl.Empty
	12, // 93: JoystickControl.JoystickControl.getGamepads:output_type -> JoystickControl.GetGamepadsRes
	9,  // 94: JoystickControl.JoystickControl.getTransmitters:output_type -> JoystickControl.GetTransmitterRes
	14, // 95: JoystickControl.JoystickControl.getConfig:output_type -> JoystickControl.GetConfigRes
	7,  // 96: JoystickControl.JoystickControl.setConfig:output_type -> JoystickControl.Empty
	16, // 97: JoystickControl.JoystickControl.validateConfig:output_type -> JoystickControl.ValidateConfigRes
	7,  // 98: JoystickControl.JoystickControl.startLink:output_type -> JoystickControl.Empty
	7,  // 99: JoystickControl.JoystickControl.stopLink:output_type -> JoystickControl.Empty
	7,  // 100: JoystickControl.JoystickControl.startHTTP:output_type -> JoystickControl.Empty
	7,  // 101: JoystickControl.JoystickControl.stopHTTP:output_type -> JoystickControl.Empty
	26, // 102: JoystickControl.JoystickControl.getLinkStream:output_type -> JoystickControl.LinkState
	27, // 103: JoystickControl.JoystickControl.getTelemetryStream:output_type -> JoystickControl.Telemetry
	25, // 104: JoystickControl.JoystickControl.getEvalStream:output_type -> JoystickControl.EvalStates
	22, // 105: JoystickControl.JoystickControl.getTransmitterStream:output_type -> JoystickControl.TransmitterChannels
	20, // 106: JoystickControl.JoystickControl.getGamepadStream:output_type -> JoystickControl.GamepadInputsStates
	43, // 107: JoystickControl.JoystickControl.getCRSFDevices:output_type -> JoystickControl.GetCRSFDevicesRes
	44, // 108: JoystickControl.JoystickControl.getCRSFDeviceFields:output_type -> JoystickControl.GetCRSFDeviceFieldsRes
	62, // 109: JoystickControl.JoystickControl.getCRSFDeviceField:output_type -> JoystickControl.GetCRSFDeviceFieldRes
	64, // 110: JoystickControl.JoystickControl.setCRSFDeviceField:output_type -> JoystickControl.SetCRSFDeviceFieldRes
	65, // 111: JoystickControl.JoystickControl.getCRSFDeviceLinkStatus:output_type -> JoystickControl.GetCRSFDeviceLinkStatusRes
	7,  // 112: JoystickControl.JoystickControl.clearCRSFDeviceLinkCriticalFlags:output_type -> JoystickControl.Empty
	42, // 113: JoystickControl.JoystickControl.getAppInfo:output_type -> JoystickControl.GetAppInfoRes
	66, // 114: JoystickControl.JoystickControl.WatchHeadIntentDiagnostics:output_type -> JoystickControl.HeadIntentDiagnostics
...
func file_server_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_server_proto_msgTypes[59].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*HeadIntentDiagnostics); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
